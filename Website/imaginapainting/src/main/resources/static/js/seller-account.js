...
function addSellerArtwork() {
  ...
  $('#sellerAccountPageListArtworkSectionAddItemSaveButton').attr('disabled', true);
  ...
  $.ajax({
    ...
    cache: false,
    beforeSend: function () {
      $('#uploadStatusAdd').html('<img src="uploaded-photos/uploading.gif"/>');
    },
    success: function (data, status) {
      setTimeout(function () {
        $('#uploadStatusAdd').html('');
        loadSellerArtwork();
        $('#sellerAccountPageListArtworkSectionAddItemModal').modal('hide');
        $('#sellerAccountPageListArtworkSectionAddItemSaveButton').attr('disabled', false);
      }, 2000);
    },
    error: function (xhr, status, error) {
      var err = eval("(" + xhr.responseText + ")");
...
function editSellerArtworkSubmit() {
  ...
  $('#sellerAccountPageListArtworkSectionEditItemSaveButton').attr('disabled', true);
  ...
  $.ajax({
    ...
    cache: false,
    beforeSend: function () {
      $('#uploadStatusEdit').html('<img src="uploaded-photos/uploading.gif"/>');
    },
    success: function (data, status) {
      setTimeout(function () {
        $('#uploadStatusEdit').html('');
        loadSellerArtwork();
        $('#sellerAccountPageListArtworkSectionEditItemModal').modal('hide');
        $('#sellerAccountPageListArtworkSectionEditItemSaveButton').attr('disabled', false);
      }, 2000);
    },
    error: function (xhr, status, error) {
      var err = eval("(" + xhr.responseText + ")");
...
function editPublicProfileDetails() {
  ...
  $('#sellerAccountPagePublicProfileDetailsSaveButton').attr('disabled', true);
  ...
  $.ajax({
    ...
    cache: false,
    beforeSend: function () {
      $('#uploadStatusPublic').html('<img src="uploaded-photos/uploading.gif"/>');
    },
    success: function (data, status) {
      setTimeout(function () {
        $('#uploadStatusPublic').html('');
        loadPublicProfileDetails();
        $('#sellerAccountPagePublicProfileDetailsSaveButton').attr('disabled', false);
      }, 2000);
    },
    error: function (xhr, status, error) {
      var err = eval("(" + xhr.responseText + ")");
